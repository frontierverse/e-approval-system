...
const cellInputClassName =
  "h-9 w-16 rounded-md border border-[#cfd6e3] bg-white px-2 text-center text-sm outline-none transition focus:border-[#196b69] focus:ring-2 focus:ring-[#d7eceb]";
...
export function LunchBoxCountGrid({
  ...
  function handleFieldChange(
    ...
    setEdits((current) => {
      ...
      return {
        ...current,
        [schoolId]: { ...base, [field]: parsedValue },
      };
    });
  }
      ...
      <div className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-b border-[#eef1f5] px-5 py-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <DatePickerInput
            ...
            className="h-10 rounded-md border border-[#cfd6e3] bg-white px-3 text-sm outline-none"
          />
          <button
            type="button"
            disabled={isPending}
            ...
            <table className="w-full min-w-[720px] border-collapse text-sm">
              <thead>
                <tr className="text-left text-xs font-semibold text-[#697386]">
                  <th className="sticky top-0 z-20 border-b border-[#eef1f5] bg-white py-3 pr-3">
                    학교명
                  </th>
                  ...
                  <th className="sticky top-0 z-20 border-b border-[#eef1f5] bg-white px-2 py-3 text-center">
                    합계
                  </th>
                </tr>
              </thead>
                  ...
                  return (
                    ...
                    >
                      <td className="py-2 pr-3">
                        ...
                        <span className="ml-2 rounded-full border border-[#cfd6e3] px-2 py-0.5 text-xs text-[#697386]">
