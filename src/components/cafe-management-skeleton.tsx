  ...
  return (
    ...
    >
      ...
      <div className="mt-5 grid min-w-0 gap-4 lg:grid-cols-4">
        ...
        <CafeFieldSkeleton className="lg:-mt-2" label="물품 종류" />
        <CafeFieldSkeleton className="lg:-mt-2" label="가격" />
        <CafeDateFieldSkeleton className="lg:col-span-2" label="유통기한" />
        <CafeFieldSkeleton className="lg:col-span-3" label="구매 사유" />
        <CafeSkeletonBlock className="h-10 w-full self-end lg:w-20" />
      </div>
    </section>
  );
}
