    ...
    >
      <div className="border-b border-[#eef1f5] px-5 py-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            <CafeSkeletonBlock className="h-8 w-40" />
      ...
      <div className="overflow-x-auto">
        <div className="w-max min-w-[1152px] max-w-none text-sm">
          <div className="grid grid-cols-[12rem_8rem_9rem_10rem_9rem_8rem_6rem_10rem] border-b border-[#eef1f5] bg-[#f7f9fc] text-xs font-semibold text-[#394150]">
            {[
              "물품",
              "종류",
              "구매일",
          ...
          {[0, 1, 2, 3].map((row) => (
            <div
              key={row}
              className="grid grid-cols-[12rem_8rem_9rem_10rem_9rem_8rem_6rem_10rem] border-b border-[#eef1f5] last:border-b-0"
            >
              ...
              <div className="px-6 py-5">
                <div className="flex gap-2">
                  <CafeSkeletonBlock className="h-9 w-12" />
                  <CafeSkeletonBlock className="h-9 w-12" />
                </div>
              </div>
            </div>
...
export function CafeItemChangeLogSkeleton() {
  return (
    <section
      aria-label="카페 물품 변경내역 로딩"
      className="rounded-md border border-[#d9dee7] bg-white shadow-sm"
    >
      <div className="border-b border-[#eef1f5] px-5 py-4">
        ...
        <div className="mt-4 flex min-w-0 flex-wrap items-end gap-2">
          <CafeFieldSkeleton className="w-56" label="검색" />
          <CafeFieldSkeleton className="w-36" label="작업" />
          <CafeFieldSkeleton className="w-40" label="직원" />
          <CafeSkeletonBlock className="h-10 w-20" />
          <CafeSkeletonBlock className="h-10 w-20" />
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        <div className="w-full min-w-[900px] text-sm">
          <div className="grid grid-cols-[10rem_7rem_14rem_10rem_minmax(22rem,1fr)] border-b border-[#eef1f5] bg-[#f7f9fc] text-xs font-semibold text-[#394150]">
            {["일시", "작업", "물품", "직원", "내용"].map((label) => (
              <div key={label} className="px-6 py-3.5">
                {label}
              </div>
            ))}
          ...
          {[0, 1, 2].map((row) => (
            <div
              key={row}
              className="grid grid-cols-[10rem_7rem_14rem_10rem_minmax(22rem,1fr)] border-b border-[#eef1f5] last:border-b-0"
            >
              <CafeTableCellSkeleton />
              <div className="px-6 py-5">
                <CafeSkeletonBlock className="h-8 w-14 rounded-md" />
              </div>
              <CafeTableCellSkeleton />
              <CafeTableCellSkeleton />
              <div className="px-6 py-5">
                <CafeSkeletonBlock className="h-4 w-56 max-w-full" />
                <CafeSkeletonBlock className="mt-2 h-4 w-72 max-w-full" />
              </div>
            </div>
          ))}
        </div>
