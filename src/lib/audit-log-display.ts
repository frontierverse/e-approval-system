...
export const auditActionBadgeClasses: Record<AuditActionValue, string> = {
  ...
  DISCARD_DOCUMENT: "border-[#cfd6e3] bg-[#eef1f5] text-[#394150]",
  RESTORE_DOCUMENT: "border-[#bdd7f0] bg-[#edf6ff] text-[#245d8f]",
  ...
  UPDATE_COMPANY_INFO: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  ...
  UPDATE_WORK_LOG: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  UPDATE_STAFF_TASK: "border-[var(--border)] bg-[var(--brand-soft)] text-[var(--brand)]",
  UPDATE_CAFE_ITEM: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  UPDATE_LUNCH_BOX_COUNT: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  UPDATE_LUNCH_BOX_OPERATION: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  CREATE_YOUTH: "border-[#b8d9d7] bg-[#eef7f6] text-[#196b69]",
  UPDATE_YOUTH: "border-[#c9d6ea] bg-[#f3f7fc] text-[#3f5f8c]",
  EXTEND_YOUTH_DISCHARGE: "border-[#f0c6c6] bg-[#fff1f1] text-[#9d3328]",
  ...
  VIEW_YOUTH_DETAIL: "border-[#cfd6e3] bg-[#f7f9fc] text-[#394150]",
  VIEW_YOUTH_CONTACT: "border-[#ead8a8] bg-[#fff8df] text-[#82620d]",
};
...
export const auditActionTextClasses: Record<AuditActionValue, string> = {
  ...
  REJECT: "text-[#8a1f1f]",
  RECALL: "text-[#82620d]",
  DISCARD_DOCUMENT: "text-[#394150]",
  RESTORE_DOCUMENT: "text-[#245d8f]",
  ...
  UPDATE_COMPANY_INFO: "text-[#196b69]",
  CHANGE_PASSWORD: "text-[#394150]",
  CREATE_RESOURCE: "text-[#196b69]",
  UPDATE_RESOURCE: "text-[#3f5f8c]",
  DELETE_RESOURCE: "text-[#8a1f1f]",
  UPDATE_WORK_LOG: "text-[#196b69]",
  UPDATE_STAFF_TASK: "text-[var(--brand)]",
  UPDATE_CAFE_ITEM: "text-[#196b69]",
  UPDATE_LUNCH_BOX_COUNT: "text-[#196b69]",
  UPDATE_LUNCH_BOX_OPERATION: "text-[#196b69]",
  CREATE_YOUTH: "text-[#196b69]",
  UPDATE_YOUTH: "text-[#3f5f8c]",
  EXTEND_YOUTH_DISCHARGE: "text-[#9d3328]",
  UPDATE_YOUTH_NOTE: "text-[#82620d]",
  DELETE_YOUTH_NOTE: "text-[#8a1f1f]",
  DOWNLOAD_YOUTH_DECISION_DOCUMENT: "text-[#245d8f]",
  VIEW_YOUTH_DETAIL: "text-[#394150]",
  VIEW_YOUTH_CONTACT: "text-[#82620d]",
};
